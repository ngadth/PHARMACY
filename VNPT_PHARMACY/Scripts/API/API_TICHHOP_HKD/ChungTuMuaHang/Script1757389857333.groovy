...
RequestObject req = findTestObject('API/API_TICHHOP_HKD/ChungTuMuaHang')

def resp = WS.sendRequest(findTestObject('API/API_TICHHOP_HKD/ChungTuMuaHang', [('access_token') : GlobalVariable.access_token]))
