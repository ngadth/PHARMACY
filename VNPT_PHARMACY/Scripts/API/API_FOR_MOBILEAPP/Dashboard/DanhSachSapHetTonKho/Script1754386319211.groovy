...
RequestObject req = (RequestObject)findTestObject('API/API_FOR_MOBILEAPP/Dashboard/DanhSachHangSapHetTonKho')
...
// ▶ Now fire your List Product out request
ResponseObject response = WS.sendRequest(
	findTestObject('API/API_FOR_MOBILEAPP/Dashboard/DanhSachHangSapHetTonKho', [
...
String actualKhoId = WS.getElementPropertyValue(response, 'map.rs[0].IN_WAREHOUSE_ID').toString()
