...
WebUI.click(findTestObject('Common/menu_aDynamicLocators', [('text') : 'Phải trả NCC']))

WebUI.waitForElementVisible(findTestObject('XuatKhoBanHang/text_bDynamicLocators', [('text') : 'Công nợ phải trả nhà cung cấp']), 5)
...
GlobalVariable.name_service = '1122'
...
WebUI.click(findTestObject('CongNo/button_spaceTextDynamicLocators', [('buttonName') : 'Cập nhật công nợ']))

WebUI.delay(5)

WebUI.waitForElementVisible(findTestObject('XuatKhoBanHang/text_bDynamicLocators', [('text') : 'Cập nhật công nợ với automation nha cung cap']),3)

GlobalVariable.soHDDT = '100'

WebUI.setText(findTestObject('XuatKhoBanHang/input_idDynamicLocatorsFirst', [('idValue') : 'TE9k5zPu4O..']), GlobalVariable.soHDDT)
...
WebUI.setText(findTestObject('XuatKhoBanHang/textarea_idDynamicLocators', [('idValue') : 'TFXwPyXf4yXx']), 'Ghi chú Cập nhật công nợ')

WebUI.click(findTestObject('QuanLyKho/button_textDynamicLocatorsLast', [('buttonName') : 'Lưu']))

WebUI.acceptAlert()

WebUI.waitForElementVisible(findTestObject('Common/noti_h4ThanhCong', [('text') : 'Cập nhật số dư thành công, phiếu:']), 5)

String value = WebUI.getText(findTestObject('QuanLyKho/cell_2table', [('idValue') : '6']))

int number = Integer.parseInt(value)

int cuaHangtra = Math.abs(number)

println(cuaHangtra)

WebUI.verifyEqual(cuaHangtra, GlobalVariable.soHDDT)
