...
WebUI.click(findTestObject('Common/menu_aDynamicLocators', [('text') : 'Báo cáo tổng hợp công nợ với NCC']))

WebUI.delay(1)

WebUI.verifyElementVisible(findTestObject('Common/text_divDynamicLocators', [('text') : 'Báo cáo tổng hợp công nợ nhà cung cấp']))
...
WebUI.setText(findTestObject('XuatKhoBanHang/input_tenKhachHang', [('idValue') : 'id_khachhang']), '1122')
