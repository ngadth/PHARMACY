...
WebUI.click(findTestObject('Common/menu_aDynamicLocators', [('text') : 'Báo cáo tổng hợp công nợ phải thu KH']))

WebUI.delay(1)

WebUI.verifyElementVisible(findTestObject('Common/text_divDynamicLocators', [('text') : 'Báo cáo tổng hợp công nợ khách hàng']))

WebUI.selectOptionByLabel(findTestObject('Common/dropdown_selectDynamicLocators', [('idValue') : 'id_kho']), 'SHOP6-CH 6', false)
...
WebUI.setText(findTestObject('XuatKhoBanHang/input_tenKhachHang', [('idValue') : 'id_khachhang']), 'Auto_test01')

WebUI.sendKeys(findTestObject('XuatKhoBanHang/input_tenKhachHang', [('idValue') : 'id_khachhang']), Keys.chord(Keys.ENTER))
