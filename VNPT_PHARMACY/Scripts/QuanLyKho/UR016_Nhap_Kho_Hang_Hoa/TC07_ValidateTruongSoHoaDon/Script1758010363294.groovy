...
WebUI.sendKeys(ghiChuField, 'Nhập kho hàng hóa - Test Số hóa đơn')

String invoiceValue = "<script>alert(123)</script>"

WebUI.setText(findTestObject('XuatKhoBanHang/input_tenKhachHang', [('idValue') : 'TFXwSy9GPo..']), invoiceValue)
...
String savedInvoiceValue = WebUI.getAttribute(findTestObject('XuatKhoBanHang/input_tenKhachHang', [('idValue') : 'TFXwSy9GPo..']), 'value')

WebUI.verifyEqual(savedInvoiceValue, invoiceValue, FailureHandling.STOP_ON_FAILURE)
