...
//WebUI.sendKeys(findTestObject('QuanLyKho/input_labelDynamicLocators', [('labelValue') : 'Thủ kho nhập ']), 'Thủ kho nhập Edit')

WebUI.click(findTestObject('Object Repository/Common/text_aDynamicLocators', [('text') : 'Hàng đã nhập kho']))

WebUI.click(findTestObject('Object Repository/QuanLyKho/span_productRemove'))

WebUI.waitForElementVisible(findTestObject('Admin/Common/text_hDynamicLocators', [('text') : 'Xác nhận hủy loại hàng đã nhập']), 3)
