...
WebUI.sendKeys(findTestObject('Common/input_idDynamicLocators', [('idValue') : 'TFAh6E9X']), 'Acemuc')
...
WebUI.click(findTestObject('Object Repository/Common/li_idDynamicLocators', [('idValue') : 'homepage']))
...
WebUI.waitForElementVisible(findTestObject('Common/noti_h4ThanhCong', [('text') : 'Có lỗi xảy ra: Có sản phẩm đã được BÁN hoặc XUẤT KHO, không thể xóa phiếu nhập kho!']), 10)
