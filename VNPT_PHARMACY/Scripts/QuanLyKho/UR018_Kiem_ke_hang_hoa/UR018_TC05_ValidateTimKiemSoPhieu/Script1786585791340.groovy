...
//mac dinh
String value =  WebUI.getAttribute(findTestObject('Common/input_placeholderDynamicLocators', [('text') : 'Số phiếu', ('index') : '1']), 'value')

assert value.trim() == ''

// copy paste

WebUI.setText(findTestObject('Common/input_placeholderDynamicLocators', [('text') : 'Loại hàng hóa', ('index') : '1']), 'Trần Minh Tiến')
...
assert value1.trim() == 'Trần Minh Tiến'

// < 20
WebUI.setText(findTestObject('Common/input_placeholderDynamicLocators', [('text') : 'Số phiếu', ('index') : '1']), 'Trần Minh Tiến Trần Minh Tiến Trần Minh Tiến Trần Minh Tiến')

WebUI.sendKeys(findTestObject('Common/input_placeholderDynamicLocators', [('text') : 'Loại hàng hóa', ('index') : '1']), Keys.ENTER.toString())

String notiLoi = 'Phiếu ID phải có độ dài nằm trong khoảng 0-10'

WebUI.assertElementVisible(findTestObject('Common/noti_h4ThanhCong',[('text'):notiLoi]), 3)
