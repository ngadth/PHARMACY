...
// Test trường "Đơn vị vận chuyển" - trường không bắt buộc, cho phép chữ và số
String dvvcValue = 'Unit123'

WebUI.waitForElementVisible(findTestObject('QuanLyKho/input_labelDynamicLocators', [('labelValue') : 'Đơn vị vận chuyển']), 10)
WebUI.click(findTestObject('QuanLyKho/input_labelDynamicLocators', [('labelValue') : 'Đơn vị vận chuyển']), FailureHandling.OPTIONAL)
WebUI.sendKeys(findTestObject('QuanLyKho/input_labelDynamicLocators', [('labelValue') : 'Đơn vị vận chuyển']), dvvcValue)
