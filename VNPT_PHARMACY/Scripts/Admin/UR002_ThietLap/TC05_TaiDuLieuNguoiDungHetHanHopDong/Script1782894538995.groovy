...
CustomKeywords.'libKeyWords.PageObject.openSubmenu'('THIẾT LẬP', 'Tải dữ liệu của người dùng hết hạn hợp đồng')

WebUI.verifyElementVisible(findTestObject('Common/titlePage_bDynamicLocators', [('text') : 'Tải dữ liệu người dùng']))
...
// Tải file
WebUI.click(findTestObject('Common/button_spanDynamicLocators', [('buttonName') : 'Tải về']))
