...
WebUI.click(findTestObject('Common/menu_aDynamicLocators', [('text') : 'Hoàn thiện hợp đồng']))
...
WebUI.verifyElementVisible(findTestObject('Common/noti_h4ThanhCong', [('text') : 'Cập nhật thành công']))
