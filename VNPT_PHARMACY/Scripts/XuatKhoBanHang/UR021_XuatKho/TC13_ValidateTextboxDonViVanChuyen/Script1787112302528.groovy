...
//mac dinh
String value = WebUI.getAttribute(findTestObject('XuatKhoBanHang/input_tenKhachHang', [('idValue') : 'diachinhanhang']),'value')

assert value.trim() == ''

// khong bat buoc
WebUI.verifyElementNotPresent(findTestObject('Object Repository/Common/label_Required',[('fieldName'):'Đơn vị vận chuyển']), 0)
...
WebUI.setText(findTestObject('XuatKhoBanHang/input_tenKhachHang', [('idValue') : 'donvivanchuyen']), '')
...
WebUI.setText(findTestObject('XuatKhoBanHang/input_tenKhachHang', [('idValue') : 'donvivanchuyen']), 'ABC-234')

WebUI.sendKeys(findTestObject('XuatKhoBanHang/input_tenKhachHang', [('idValue') : 'donvivanchuyen']), ' <script>alert(document.cookie)</script>')
