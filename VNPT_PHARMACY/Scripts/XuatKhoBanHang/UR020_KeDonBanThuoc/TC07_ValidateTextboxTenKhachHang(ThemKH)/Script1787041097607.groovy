...
// mac dinh
String value = WebUI.getAttribute(findTestObject('QuanLyKho/input_labelIndexDynamicLocators', [('labelValue') : 'Tên KH ', ('index') : '2']),'value')
...
WebUI.setText(findTestObject('QuanLyKho/input_labelIndexDynamicLocators', [('labelValue') : 'Tên KH ', ('index') : '2']),'@#$')
...
WebUI.setText(findTestObject('QuanLyKho/input_labelIndexDynamicLocators', [('labelValue') : 'Tên KH ', ('index') : '2']),'123456789')
...
WebUI.setText(findTestObject('QuanLyKho/input_labelIndexDynamicLocators', [('labelValue') : 'Tên KH ', ('index') : '2']), 'trịnh trân phương tuấn')

WebUI.sendKeys(findTestObject('QuanLyKho/input_labelIndexDynamicLocators', [('labelValue') : 'Tên KH ', ('index') : '2']), Keys.chord(Keys.CONTROL, 'A'))
WebUI.sendKeys(findTestObject('QuanLyKho/input_labelIndexDynamicLocators', [('labelValue') : 'Tên KH ', ('index') : '2']), Keys.chord(Keys.CONTROL, 'C'))

WebUI.setText(findTestObject('QuanLyKho/input_labelIndexDynamicLocators', [('labelValue') : 'Tên KH ', ('index') : '2']), '')

WebUI.sendKeys(findTestObject('QuanLyKho/input_labelIndexDynamicLocators', [('labelValue') : 'Tên KH ', ('index') : '2']), Keys.chord(Keys.CONTROL, 'V'))
