...
WebUI.click(findTestObject('Common/input_idDynamicLocators',[('idValue'):'userchoice1']))

WebUI.click(findTestObject('QuanLyKho/button_textDynamicLocators',[('buttonName'):'Hủy bán hàng hóa đã chọn']))
