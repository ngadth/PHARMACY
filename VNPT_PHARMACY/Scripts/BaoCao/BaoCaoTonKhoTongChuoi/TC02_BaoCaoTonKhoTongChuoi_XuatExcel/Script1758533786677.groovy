...
String startName = 'TonKhoTongChuoi'
...
WebUI.click(findTestObject('BaoCaoKho/tracuu_nhomHang'))
...
WebUI.sendKeys(findTestObject('XuatKhoBanHang/input_idDynamicLocatorsLast', [('idValue') : 'CE9X63Lm3zPbCW..']), Keys.chord(
        Keys.ENTER))
