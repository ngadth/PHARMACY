...
String date = ('14/12/2025' + ' - ') + '16/12/2025'
...
String startName = 'SOTHEODOICHATLUONGTHUOC'
...
WebUI.click(findTestObject('Common/option_liDynamicLocators', [('optionName') : 'Báo cáo sổ theo dõi chất lượng thuốc định kỳ ']))
