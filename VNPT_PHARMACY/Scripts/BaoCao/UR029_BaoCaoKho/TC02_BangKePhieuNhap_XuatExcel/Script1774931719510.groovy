...
String date = ('20/09/2023' + ' - ') + '22/09/2025'
...
String startName = 'BANGKEPHIEUNHAP'
...
WebUI.click(findTestObject('Common/option_liDynamicLocators', [('optionName') : 'Bảng kê phiếu nhập']))
...
WebUI.setText(findTestObject('Common/input_idDynamicLocators', [('idValue') : 'CE9X63Lm3zPbCW..']), 'ỐNG TIÊM 5 ML')

WebUI.sendKeys(findTestObject('Common/input_idDynamicLocators', [('idValue') : 'CE9X63Lm3zPbCW..']), Keys.chord(Keys.ENTER))
