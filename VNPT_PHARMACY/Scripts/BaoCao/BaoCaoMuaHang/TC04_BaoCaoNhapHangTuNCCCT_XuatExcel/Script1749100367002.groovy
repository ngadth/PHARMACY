...
String startName = 'BANG_KE_NHAP_HANG_NCC_CT'
...
WebUI.click(findTestObject('Common/option_liDynamicLocators',[('optionName'):'Báo cáo nhập hàng từ Nhà cung cấp CT']))

WebUI.verifyElementVisible(findTestObject('Common/titlePage_bDynamicLocators',[('text'):'Báo cáo nhập hàng từ Nhà cung cấp CT']))
