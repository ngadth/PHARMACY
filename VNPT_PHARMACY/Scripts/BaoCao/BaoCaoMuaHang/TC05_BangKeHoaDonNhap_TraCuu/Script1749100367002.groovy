...
String columnTable = 'Kho;Loại HĐ;Tên NCC;Ngày HĐ;Số HĐ;Tiền hàng;Chiết khấu;Sau CK;Tiền thuế;Thành tiền'
...
WebUI.click(findTestObject('Common/option_liDynamicLocators', [('optionName') : 'Bảng kê hóa đơn nhập']))

WebUI.verifyElementVisible(findTestObject('Common/titlePage_bDynamicLocators', [('text') : 'Bảng kê hóa đơn nhập']))
...
kho = WebUI.getText(findTestObject('Common/cell_tdDynamicLocators', [('index') : '1']))

WebUI.verifyEqual(kho, 'CH01 - Của hàng 01')
