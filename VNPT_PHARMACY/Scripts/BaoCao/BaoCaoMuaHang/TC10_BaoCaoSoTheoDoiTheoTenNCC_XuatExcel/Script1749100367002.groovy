...
String startName = 'CLOUD_33364SOTHEODOITEN_NHACUNGCAP'
...
WebUI.click(findTestObject('Common/option_liDynamicLocators',[('optionName'):'Báo cáo sổ theo dõi tên Nhà cung cấp']))

WebUI.verifyElementVisible(findTestObject('Common/titlePage_bDynamicLocators',[('text'):'Báo cáo sổ theo dõi tên Nhà cung cấp']))
