...
// tg ban hang > hien tai
WebUI.setText(findTestObject('Common/input_idDynamicLocators',[('idValue'):'searchDate']),'12/02/2030 - 19/02/2030')

WebUI.sendKeys(findTestObject('Common/input_idDynamicLocators',[('idValue'):'searchDate']),Keys.chord(Keys.ENTER))

WebUI.assertElementPresent(findTestObject('Common/text_tdDynamicLocators',[('text'):'Không tìm thấy dữ liệu...']), 3)

WebUI.refresh()
// loai SP khong ton tai
...
WebUI.click(findTestObject('Common/option_liDynamicLocators',[('optionName'):'thuốc điều trị tăng lipid máu']))

WebUI.assertElementPresent(findTestObject('Common/text_tdDynamicLocators',[('text'):'Không tìm thấy dữ liệu...']), 3)

WebUI.refresh()

// cuahang chua ban sp nao
...
WebUI.click(findTestObject('Common/option_liDynamicLocators',[('optionName'):'7995-Cua Hang Automation']))
