...
String startName = 'BaoCaoBanHangTheoKHvaSP'
...
WebUI.assertElementPresent(findTestObject('Common/text_tdDynamicLocators',[('text'):'Saphnelo']), 3)
...
def valueI13 = sheet.getRow(12).getCell(8).toString()
def valueJ13 = sheet.getRow(12).getCell(9).toString()

WebUI.verifyMatch(valueI13, '2.0', false)
WebUI.verifyMatch(valueJ13, '600.0', false)
