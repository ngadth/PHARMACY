...
String date = ('29/09/2025' + ' - ') + '01/10/2025'
...
WebUI.setText(findTestObject('XuatKhoBanHang/input_idDynamicLocatorsLast', [('idValue') : 'loaisp_ten']),'000062')
