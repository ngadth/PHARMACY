...
// mac dinh
String value = WebUI.getAttribute(findTestObject('Common/input_idDynamicLocators',[('idValue'):'loaisp_ten']),'value')
assert value.trim() == ''

// copy paste
WebUI.setText(findTestObject('Common/input_idDynamicLocators',[('idValue'):'loaisp_ten']), 'Mạnh Thường Quân')

WebUI.sendKeys(findTestObject('Common/input_idDynamicLocators',[('idValue'):'loaisp_ten']), Keys.chord(Keys.CONTROL, 'A'))
WebUI.sendKeys(findTestObject('Common/input_idDynamicLocators',[('idValue'):'loaisp_ten']), Keys.chord(Keys.CONTROL, 'C'))

WebUI.setText(findTestObject('Common/input_idDynamicLocators',[('idValue'):'loaisp_ten']), '')

WebUI.sendKeys(findTestObject('Common/input_idDynamicLocators',[('idValue'):'loaisp_ten']), Keys.chord(Keys.CONTROL, 'V'))

String value1 = WebUI.getAttribute(findTestObject('Common/input_idDynamicLocators',[('idValue'):'loaisp_ten']), 'value')
assert value1 == 'Mạnh Thường Quân'
