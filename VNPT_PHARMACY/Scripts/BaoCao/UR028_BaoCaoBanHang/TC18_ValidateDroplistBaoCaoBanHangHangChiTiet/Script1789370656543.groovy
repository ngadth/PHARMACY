...
// mac dinh
String value = WebUI.getText(findTestObject('Common/dropdown_spanDynamicLocators',[('text'):'Báo cáo Bán hàng chi tiết']))

assert value == 'Báo cáo Bán hàng chi tiết'

// hien thi danh sach chu cai dau
WebUI.click(findTestObject('Common/dropdown_spanDynamicLocators',[('text'):'Báo cáo Bán hàng chi tiết']))
