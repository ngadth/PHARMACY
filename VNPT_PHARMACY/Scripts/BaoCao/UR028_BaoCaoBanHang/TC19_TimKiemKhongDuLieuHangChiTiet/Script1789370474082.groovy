...
WebUI.setText(findTestObject('Common/input_search'),'thuốc giảm đau')

WebUI.click(findTestObject('Object Repository/Common/option_liDynamicLocators',[('optionName'):'thuốc giảm đau']))
...
WebUI.click(findTestObject('Object Repository/Common/option_liDynamicLocators',[('optionName'):'SHOP3-VNPT Bà Rịa Vũng Tàu']))
