...
CustomKeywords.'libKeyWords.PageObject.openSubmenu'('DANH MỤC', 'Giá bán theo lô sản xuất')

WebUI.waitForElementVisible(findTestObject('XuatKhoBanHang/text_bDynamicLocators', [('text') : 'Quản lý giá bán theo lô sản xuất']), 
    5)
...
String loSanXuat = CustomKeywords.'libKeyWords.PageObject.randomString'('QWERTYUIASDFGHJKLZXCVBNM1234567890', 6)

GlobalVariable.maDonHang = ('GiaLoAT_' + loSanXuat)
...
String inputValue = WebUI.getAttribute(findTestObject('Common/input_idDynamicLocators', [('idValue') : '4yXf53Ph6Etx5EnV6BPV5BPfTo..']), 
    'value')

println('Giá trị của input là: ' + inputValue)

String sXuatUD = CustomKeywords.'libKeyWords.PageObject.randomString'('QWERTYUIASDFGHJKLZXCVBNM1234567890', 6)

GlobalVariable.maDonHang = ('UDGiaAuto_' + sXuatUD)

WebUI.setText(findTestObject('Admin/Common/input_idDynamicLocators', [('idValue') : 'CB9w4A9b5Ebw']), GlobalVariable.maDonHang)
...
WebUI.click(findTestObject('XuatKhoBanHang/span_idDynamicLocators', [('idValue') : 'select2-CcXlC3Lm3yba-container']))
...
WebUI.setText(findTestObject('DanhMuc/input_giabanTheoLoSX'), '9999')
