...
WebUI.setText(findTestObject('Admin/Common/input_idDynamicLocators', [('idValue') : 'txtSeri_i']), 'Seri_001')

WebUI.setText(findTestObject('Admin/Common/input_idDynamicLocators', [('idValue') : 'txtDoc_i']), '1')

WebUI.setText(findTestObject('Admin/Common/input_idDynamicLocators', [('idValue') : 'txtSoTT_i']), '001')

WebUI.selectOptionByIndex(findTestObject('Common/dropdown_selectDynamicLocators', [('idValue') : '4yHlCBt16B1V6O..']), 1)

WebUI.click(findTestObject('Common/checkbox_idDynamicLocators', [('idValue') : 'chkCoBarcode_i']))
