...
TestObject seriInput = findTestObject('Admin/Common/input_idDynamicLocators', [('idValue') : 'txtSeri_i'])
...
/* ===== Case 1: Seri đã in không phải là trường bắt buộc => tạo mới thành công ===== */
...
WebUI.waitForElementVisible(seriInput, 5)

GlobalVariable.maDonHang = generateMaQuay('SRIOP_')
...
GlobalVariable.name_service = ('Ten_Seri_Optional_' + ten1)
...
/* ===== Case 2: Không cho phép nhập ký tự đặc biệt cho Seri đã in => báo lỗi ===== */
WebUI.click(findTestObject('Common/button_buttonDynamicLocators', [('buttonName') : 'Thêm mới']))
...
GlobalVariable.maDonHang = generateMaQuay('SRISP_')

WebUI.setText(findTestObject('Admin/Common/input_idDynamicLocators', [('idValue') : 'txtMaQuay_i']), GlobalVariable.maDonHang)

String ten2 = CustomKeywords.'libKeyWords.PageObject.randomString'('1234567890ABCDRFGLJH', 5)

GlobalVariable.name_service = ('Ten_Seri_Special_' + ten2)

WebUI.setText(findTestObject('Admin/Common/input_idDynamicLocators', [('idValue') : 'txtTenQuay_i']), GlobalVariable.name_service)

WebUI.setText(seriInput, '@#$%^&*')
...
/* ===== Case 3: Nhập thẻ html/script cho Seri đã in => báo lỗi, không mã hóa khi lưu ===== */
WebUI.click(findTestObject('Common/button_buttonDynamicLocators', [('buttonName') : 'Thêm mới']))
...
GlobalVariable.maDonHang = generateMaQuay('SRIXS_')

WebUI.setText(findTestObject('Admin/Common/input_idDynamicLocators', [('idValue') : 'txtMaQuay_i']), GlobalVariable.maDonHang)

String ten3 = CustomKeywords.'libKeyWords.PageObject.randomString'('1234567890ABCDRFGLJH', 5)

GlobalVariable.name_service = ('Ten_Seri_XSS_' + ten3)

WebUI.setText(findTestObject('Admin/Common/input_idDynamicLocators', [('idValue') : 'txtTenQuay_i']), GlobalVariable.name_service)

WebUI.setText(seriInput, '<script>alert(document.cookie)</script>')
...
/* ===== Case 4: Seri đã in cho phép nhập chữ số => tạo mới thành công ===== */
WebUI.click(findTestObject('Common/button_buttonDynamicLocators', [('buttonName') : 'Thêm mới']))
...
GlobalVariable.maDonHang = generateMaQuay('SRINB_')

WebUI.setText(findTestObject('Admin/Common/input_idDynamicLocators', [('idValue') : 'txtMaQuay_i']), GlobalVariable.maDonHang)

String ten4 = CustomKeywords.'libKeyWords.PageObject.randomString'('1234567890ABCDRFGLJH', 5)

GlobalVariable.name_service = ('Ten_Seri_Number_' + ten4)

WebUI.setText(findTestObject('Admin/Common/input_idDynamicLocators', [('idValue') : 'txtTenQuay_i']), GlobalVariable.name_service)

WebUI.setText(seriInput, '1234567890')
...
/* ===== Case 5: Seri đã in cho phép nhập chữ và số => tạo mới thành công ===== */
WebUI.click(findTestObject('Common/button_buttonDynamicLocators', [('buttonName') : 'Thêm mới']))
...
GlobalVariable.maDonHang = generateMaQuay('SRIAN_')

WebUI.setText(findTestObject('Admin/Common/input_idDynamicLocators', [('idValue') : 'txtMaQuay_i']), GlobalVariable.maDonHang)

String ten5 = CustomKeywords.'libKeyWords.PageObject.randomString'('1234567890ABCDRFGLJH', 5)

GlobalVariable.name_service = ('Ten_Seri_AlphaNum_' + ten5)

WebUI.setText(findTestObject('Admin/Common/input_idDynamicLocators', [('idValue') : 'txtTenQuay_i']), GlobalVariable.name_service)

WebUI.setText(seriInput, 'A12B34C56')
...
String maQuay5 = CustomKeywords.'libKeyWords.PageObject.getValueInTableByColumnName'('Mã quầy', 0, 'table_quaythu')

WebUI.verifyEqual(maQuay5, GlobalVariable.maDonHang)
