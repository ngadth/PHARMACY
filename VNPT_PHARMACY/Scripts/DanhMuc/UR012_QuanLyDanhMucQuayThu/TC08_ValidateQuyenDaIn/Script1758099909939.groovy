...
TestObject quyenInput = findTestObject('Admin/Common/input_idDynamicLocators', [('idValue') : 'txtDoc_i'])
...
/* ===== Case 1: Quyển đã in không phải là trường bắt buộc => tạo mới thành công ===== */
...
WebUI.waitForElementVisible(quyenInput, 5)

GlobalVariable.maDonHang = generateMaQuay('QUOP_')
...
GlobalVariable.name_service = ('Ten_Quyen_Optional_' + ten1)
...
/* ===== Case 2: Không cho phép nhập ký tự đặc biệt cho Quyển đã in => báo lỗi ===== */
WebUI.click(findTestObject('Common/button_buttonDynamicLocators', [('buttonName') : 'Thêm mới']))
...
GlobalVariable.maDonHang = generateMaQuay('QUSP_')

WebUI.setText(findTestObject('Admin/Common/input_idDynamicLocators', [('idValue') : 'txtMaQuay_i']), GlobalVariable.maDonHang)

String ten2 = CustomKeywords.'libKeyWords.PageObject.randomString'('1234567890ABCDRFGLJH', 5)

GlobalVariable.name_service = ('Ten_Quyen_Special_' + ten2)

WebUI.setText(findTestObject('Admin/Common/input_idDynamicLocators', [('idValue') : 'txtTenQuay_i']), GlobalVariable.name_service)

WebUI.setText(quyenInput, '@#$%^&*')
...
/* ===== Case 3: Nhập thẻ html/script cho Quyển đã in => báo lỗi, không mã hóa khi lưu ===== */
WebUI.click(findTestObject('Common/button_buttonDynamicLocators', [('buttonName') : 'Thêm mới']))
...
GlobalVariable.maDonHang = generateMaQuay('QUXS_')

WebUI.setText(findTestObject('Admin/Common/input_idDynamicLocators', [('idValue') : 'txtMaQuay_i']), GlobalVariable.maDonHang)

String ten3 = CustomKeywords.'libKeyWords.PageObject.randomString'('1234567890ABCDRFGLJH', 5)

GlobalVariable.name_service = ('Ten_Quyen_XSS_' + ten3)

WebUI.setText(findTestObject('Admin/Common/input_idDynamicLocators', [('idValue') : 'txtTenQuay_i']), GlobalVariable.name_service)

WebUI.setText(quyenInput, '<script>alert(document.cookie)</script>')
...
/* ===== Case 4: Quyển đã in cho phép nhập chữ số (tối đa 8 ký tự số) => tạo mới thành công ===== */
WebUI.click(findTestObject('Common/button_buttonDynamicLocators', [('buttonName') : 'Thêm mới']))
...
GlobalVariable.maDonHang = generateMaQuay('QUNB_')

WebUI.setText(findTestObject('Admin/Common/input_idDynamicLocators', [('idValue') : 'txtMaQuay_i']), GlobalVariable.maDonHang)

String ten4 = CustomKeywords.'libKeyWords.PageObject.randomString'('1234567890ABCDRFGLJH', 5)

GlobalVariable.name_service = ('Ten_Quyen_Number_' + ten4)

WebUI.setText(findTestObject('Admin/Common/input_idDynamicLocators', [('idValue') : 'txtTenQuay_i']), GlobalVariable.name_service)

WebUI.setText(quyenInput, '12345678')
...
/* ===== Case 5: Quyển đã in không cho phép nhập chữ và số (chỉ nhận ký tự số) => báo lỗi ===== */
WebUI.click(findTestObject('Common/button_buttonDynamicLocators', [('buttonName') : 'Thêm mới']))
...
GlobalVariable.maDonHang = generateMaQuay('QUAN_')

WebUI.setText(findTestObject('Admin/Common/input_idDynamicLocators', [('idValue') : 'txtMaQuay_i']), GlobalVariable.maDonHang)

String ten5 = CustomKeywords.'libKeyWords.PageObject.randomString'('1234567890ABCDRFGLJH', 5)

GlobalVariable.name_service = ('Ten_Quyen_AlphaNum_' + ten5)

WebUI.setText(findTestObject('Admin/Common/input_idDynamicLocators', [('idValue') : 'txtTenQuay_i']), GlobalVariable.name_service)

WebUI.setText(quyenInput, 'A12B34C5')
