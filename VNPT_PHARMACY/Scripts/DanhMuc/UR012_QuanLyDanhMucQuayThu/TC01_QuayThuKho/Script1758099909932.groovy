...
WebUI.waitForElementVisible(findTestObject('Admin/Common/text_hDynamicLocators', [('text') : 'Sửa quầy thu']), 5)

String maUD = CustomKeywords.'libKeyWords.PageObject.randomString'('1234567890ABCDRFGLJH', 5)

GlobalVariable.maDonHang = ('MaAutotest_' + maUD)

WebUI.setText(findTestObject('Admin/Common/input_idDynamicLocators', [('idValue') : 'txtMaQuay_e']), GlobalVariable.maDonHang)

String tenUD = CustomKeywords.'libKeyWords.PageObject.randomString'('1234567890ABCDRFGLJH', 5)

GlobalVariable.name_service = ('Tên UDAutoTest_' + tenUD)

WebUI.setText(findTestObject('Admin/Common/input_idDynamicLocators', [('idValue') : 'txtTenQuay_e']), GlobalVariable.name_service)
...
String tenQuayUD = CustomKeywords.'libKeyWords.PageObject.getValueInTableByColumnName'('Tên quầy', 0, 'table_quaythu')

WebUI.verifyEqual(maQuayUD, GlobalVariable.maDonHang)

WebUI.verifyEqual(tenQuayUD, GlobalVariable.name_service)
