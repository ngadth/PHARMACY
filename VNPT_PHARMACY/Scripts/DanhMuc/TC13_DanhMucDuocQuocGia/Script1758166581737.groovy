...
String startName = 'danhmuc_duocquocgia'
...
WebUI.waitForElementVisible(findTestObject('XuatKhoBanHang/text_bDynamicLocators', [('text') : 'Danh mục dược quốc gia']), 
    5)
...
WebUI.sendKeys(findTestObject('XuatKhoBanHang/input_tenKhachHang', [('idValue') : '3zPx6yXl4O..']), Keys.chord(Keys.ENTER))
