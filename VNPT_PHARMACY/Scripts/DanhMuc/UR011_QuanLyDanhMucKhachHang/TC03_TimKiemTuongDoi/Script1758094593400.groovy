...
String prefix = CustomKeywords.'libKeyWords.PageObject.randomString'('QWERTYUIOPASDFGHJKLZXCVBNM', 3)

String suffix = CustomKeywords.'libKeyWords.PageObject.randomString'('1234567890', 5)

GlobalVariable.name_service = ('Auto_' + prefix + '_' + suffix)
...
String tuKhoaTimKiem = 'Auto_' + prefix

WebUI.setText(findTestObject('XuatKhoBanHang/input_tenKhachHang', [('idValue') : 'ten']), tuKhoaTimKiem)

WebUI.sendKeys(findTestObject('XuatKhoBanHang/input_tenKhachHang', [('idValue') : 'ten']), Keys.chord(Keys.ENTER))

WebUI.delay(2)

String tenKHTimDuoc = CustomKeywords.'libKeyWords.PageObject.getValueInTableByColumnName'('Tên KH', 0, 'table_phieu')

assert tenKHTimDuoc.startsWith(tuKhoaTimKiem) : 'Ten KH tim duoc khong bat dau voi tu khoa tim kiem'
