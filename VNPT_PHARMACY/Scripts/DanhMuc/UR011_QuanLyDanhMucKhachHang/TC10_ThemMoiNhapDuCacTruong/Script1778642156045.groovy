...
WebUI.setText(findTestObject('Admin/Common/input_idDynamicLocators', [('idValue') : 'title']), 'Công ty ABC')

WebUI.setText(findTestObject('Admin/Common/input_idDynamicLocators', [('idValue') : 'MOBILE']), '0912345678')

WebUI.setText(findTestObject('Admin/Common/input_idDynamicLocators', [('idValue') : 'TEL']), '0281234567')

String emailRandom = (CustomKeywords.'libKeyWords.PageObject.randomString'('1234567890', 5) + '@test.com')

WebUI.setText(findTestObject('Admin/Common/input_idDynamicLocators', [('idValue') : 'EMAIL']), emailRandom)

String cccd = CustomKeywords.'libKeyWords.PageObject.randomString'('1234567890', 12)

WebUI.setText(findTestObject('Admin/Common/input_idDynamicLocators', [('idValue') : 'CCCD']), cccd)
...
WebUI.setText(findTestObject('Admin/Common/input_idDynamicLocators', [('idValue') : 'DIACHI']), '123 Đường Nguyễn Văn A, Quận Hải Châu, Đà Nẵng')

WebUI.selectOptionByLabel(findTestObject('Common/dropdown_selectDynamicLocators', [('idValue') : 'txtCompanyType']), 'Khách hàng mới', true)

WebUI.setText(findTestObject('Admin/Common/input_idDynamicLocators', [('idValue') : 'debt_limit']), '10000000')
...
WebUI.verifyEqual(diaChiCell, '123 Đường Nguyễn Văn A, Quận Hải Châu, Đà Nẵng')
