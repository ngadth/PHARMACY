...
WebUI.setText(findTestObject('Admin/Common/input_idDynamicLocators', [('idValue') : 'promotion_amount']), '1000')

WebUI.setText(findTestObject('DanhMuc/input_TuKhoa'), 'TuKhoaTest')
...
WebUI.setText(findTestObject('XuatKhoBanHang/textarea_idDynamicLocators', [('idValue') : 'note']), 'Ghi chú thêm mới hàng hóa')
...
WebUI.verifyEqual(maLoaiHang, GlobalVariable.phieuban_id)

WebUI.verifyEqual(tenLoaiHang, GlobalVariable.maKH)
